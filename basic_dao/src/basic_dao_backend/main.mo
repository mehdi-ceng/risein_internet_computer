...
shared actor class DAO(init : Types.BasicDaoStableStorage) = Self {
    //accounts and proposal are Trie
    ...
    //System paramaters such as thresholds are in system_params variable
    ...
    //Functions that modifies accounts and proposals Trie data structures
