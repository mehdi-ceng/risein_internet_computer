//For this project, I mostly used the code from the github and
//tried to understand and add my own comments.
...
module {
  ...
  //will be used to create Proposal type
  ...
  //will be used to create Proposal type and also will be used for SystemParams
  ...
  //will be used inside transfer function in main.mo to decide the receiever
  ...
  //will be used to create BasicDaoStableStorage
  ...
  //Takes array as input and converts to Trie data structure
